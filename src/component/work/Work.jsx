...
ss(cs< data.length -1 ? cs+1 : 0); 
  ...
  return (
    <div className="work" id="work">
          ...
          <div className="item">
            ...
            <div className="left">
              <div className="leftContainer">
                ...
                <a href={d.link}><span  >{d.btn}</span></a>
              </div>
            </div>
            <div className="right">
      ...
      <img src="images/down.png" alt="arrow" className="left-arrow" onClick={()=>HandleClick("left")} />
      <img src="images/down.png" alt="arrow" className="right-arrow" onClick={()=>HandleClick()} />
    </div>
  );
};
